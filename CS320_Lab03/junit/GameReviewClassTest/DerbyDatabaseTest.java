...
public class DerbyDatabaseTest {
	...
	public void insertNewCredentials() {
		...
		Integer newCredentialsID = controller.insertCredentialsIntoCredentialsTable(username, password);
		credentialsList = controller.findAllCredentials();
		for (int i = 0; i<credentialsList.size(); i++) {
			System.out.println(credentialsList.get(i).getCredentialId());
			System.out.println(credentialsList.get(i).getUsername());
		...
		System.out.println("All Credentials After Deleting New Insertion:");
		Integer removedInsertedCredential = controller.deleteCredentialsIntoCredentialsTable(username, password);
		credentialsList = controller.findAllCredentials();
		for (int i = 0; i<credentialsList.size(); i++) {
			System.out.println(credentialsList.get(i).getCredentialId());
			System.out.println(credentialsList.get(i).getUsername());
